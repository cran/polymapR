...
## 16. QTL analysis
The package `polyqtlR`, available through CRAN, has been developed for QTL analysis using IBD probabilities derived using the phased linkage maps developed in `polymapR`.
